...
**You need.** [The first run](/docs/v0.1/get-started) working.
...
for selected tool calls](/docs/v0.1/guides/approvals) shows how to read the
...
- [Call an HTTP endpoint as a tool](/docs/v0.1/guides/http-tools): a URL, a
  method and a schema in the Spec, no function.
- [Connect MCP servers](/docs/v0.1/guides/mcp): a server's whole catalogue,
  narrowed to what this agent may use.
- [Work with other agents over A2A](/docs/v0.1/guides/a2a).

## Next

- [Read what a run did](/docs/v0.1/get-started/read-a-run).
