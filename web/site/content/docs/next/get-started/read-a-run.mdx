...
**You need.** [The first run](/docs/next/get-started) working. The snippets
...
- [Inspect a run: report, status, answer](/docs/next/guides/report), the full
...
- [Persist and recover runs](/docs/next/guides/stores), so the log outlives the
  process.
